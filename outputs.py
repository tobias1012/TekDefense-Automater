...
class SiteDetailOutput(object):
    ...
    def PrintToScreenNormal(self):
        ...
        if sites is not None:
            ...
            pass
    def PrintToCEFFile(self,cefoutfile: str):
        """
    ...
    def PrintToTextFile(self,textoutfile: str):
        """
    ...
    def PrintToCSVFile(self,csvoutfile: str):
        """
    ...
    def PrintToHTMLFile(self, htmloutfile:str ):
        """
    ...
    def getHTMLClosing(self):
        ...
        return '''
            ...
            <br>
            <br>
            <p>Created using Automater.py by @tobias1012 a fork of tekdefense <a href="http://www.tekdefense.com">http://www.tekdefense.com</a>; <a href="https://github.com/tobias1012/TekDefense-Automater">https://github.com/tobias1012/TekDefense-Automater</a></p>
            </body>
            </html>
            '''